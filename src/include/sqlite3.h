...
# define double sqlite3_int64
	 ...
	 ** sqlite3_exec() is not NULL, then it is invoked for each result row /// 如果传给sqlite3_exec回调函数（第3个参数）不是空的话，就会在每次执行sql语句的时候调用。
	 ...
	 ** To avoid memory leaks, the application should invoke [sqlite3_free()] 避免内存泄露
	 ...
	 **
	 ** ^If an sqlite3_exec() callback returns non-zero, the sqlite3_exec()  回调函数的作用，回调函数返回0是正常的。
...
#define SQLITE_TRACE_CLOSE      0x08
	 ...
	 */
	SQLITE_API int sqlite3_open( //// macro SQLITE_API is just a name or a pointer -> indication you're watching a sqlite api afterwards.
...
#define SQLITE_LIMIT_WORKER_THREADS           11
	...
	SQLITE_API int sqlite3_bind_text64(sqlite3_stmt*, int, const char*,
			sqlite3_uint64, void (*)(void*), unsigned char encoding);
...
#define SQLITE3_TEXT     3
	...
	SQLITE_API int sqlite3_create_function(sqlite3 *db,
			const char *zFunctionName, int nArg, int eTextRep, void *pApp,
			void (*xFunc)(sqlite3_context*, int, sqlite3_value**),
			void (*xStep)(sqlite3_context*, int, sqlite3_value**),
			void (*xFinal)(sqlite3_context*));
	SQLITE_API int sqlite3_create_function16(sqlite3 *db,
			const void *zFunctionName, int nArg, int eTextRep, void *pApp,
			void (*xFunc)(sqlite3_context*, int, sqlite3_value**),
			void (*xStep)(sqlite3_context*, int, sqlite3_value**),
			void (*xFinal)(sqlite3_context*));
...
#define SQLITE_INDEX_CONSTRAINT_REGEXP 67
	 ...
	 */
	SQLITE_API int sqlite3_blob_open(sqlite3*, const char *zDb,
			const char *zTable, const char *zColumn, sqlite3_int64 iRow,
...
#define SQLITE_SCANSTAT_SELECTID 5
	...
	SQLITE_API SQLITE_EXPERIMENTAL int sqlite3_snapshot_get(sqlite3 *db,
			const char *zSchema, sqlite3_snapshot **ppSnapshot);
	...
	SQLITE_API SQLITE_EXPERIMENTAL int sqlite3_snapshot_open(sqlite3 *db,
			const char *zSchema, sqlite3_snapshot *pSnapshot);
...
#define _FTS5_H
	...
	struct fts5_tokenizer {
		int (*xCreate)(void*, const char **azArg, int nArg,
				Fts5Tokenizer **ppOut);
...
#define FTS5_TOKEN_COLOCATED    0x0001      /* Same position as prev. token */
	...
	struct fts5_api {
		...
		int (*xCreateTokenizer)(fts5_api *pApi, const char *zName,
				void *pContext, fts5_tokenizer *pTokenizer,
				void (*xDestroy)(void*));

		/* Find an existing tokenizer */
		int (*xFindTokenizer)(fts5_api *pApi, const char *zName,
				void **ppContext, fts5_tokenizer *pTokenizer);

		/* Create a new auxiliary function */
		int (*xCreateFunction)(fts5_api *pApi, const char *zName,
				void *pContext, fts5_extension_function xFunction,
				void (*xDestroy)(void*));
	};

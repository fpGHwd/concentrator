...
const char *c_day_success = "日数据:";
const char *c_month_success = "月数据:";
...
const char *c_current_flux_display_value_str = "当前:";
const char *c_balance_flux_amount_str = "结算日:";
const char *c_valve_status_str = "阀门:";
...
const char *c_heart_beat_min_str = "心跳周期:";
...
const char *c_current_flux_str = "当前:";
...
const char *date_test = "日期测试";
const char *invalid_meter = "无效的表ID";
const char *read_no_data = "抄表失败";
const char *inner_error = "内部错误";
const char *please_input_meter_id = "请输入表ID";
const char *read_meter_ok = "抄表成功";
const char *please_select_date = "请选择日期";
const char *meter_sum = "表总数:";
const char *no_meter = "无表";
const char *no_data = "无数据";
const char *day_data = "日数据:";
const char *no_date_index = "日期无效";
const char *date_string = "日期:";
const char *time_string = "时间:";
const char *none = "无";
const char *month_data = "月数据:";
